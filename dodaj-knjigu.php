...
<body>
  ...
  <div class="container">
    ...
    <div class="dodajknjigu">
        <h2>Додај књигу</h2>
	    <form method="post" action="dodaj-knjigu.php" enctype="multipart/form-data">
            ...
            <?php if (isset($_GET['error'])): ?>
              ...
              <?php endif ?>
		    <input type="submit" value="Додај књигу">
                    ...
                    if (isset($_FILES['slika'])){
                      ...
                      if($error === 0){
                        if($img_size > 800000 ){
                          ...
                          header("Location: dodaj-knjigu.php?error=$em"); 
                        }else{
                          ...
                          $em = "Slika nije dodana.";
                          header("Location: dodaj-knjigu.php?error=$em"); 
                      }
                  
                  }else{
                      header("Location: dodaj-knjigu.php");
                  }

                    // Kreiranje SQL upita za dodavanje novog zapisa u bazu podataka
                    $sql = "INSERT INTO knjige (naslov, autor, opis, cijena, kolicina, slika) 
                    VALUES ('$naslov', '$autor', '$opis', '$cijena', '$kolicina', '$new_img_name')";

                    // Izvršavanje SQL upita na bazi podataka
                    if ($conn->query($sql) === TRUE) {
                        echo "<p style='color: white; font-size: 16px; text-align: center;'>Књига успјешно додана</p>";
                    } else {
